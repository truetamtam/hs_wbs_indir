...
cp ${WBSHOST}/wa-config/db.php.example ${WBSHOST}/wa-config/db.php
...
awk $'/\'default\' => array\(/ { print; print "                \x27sql_mode\x27 => \x27TRADITIONAL\x27,"; next }1' ${WBSHOST}/wa-config/db.php > ${WBSHOST}/wa-config/db.php
# locale
